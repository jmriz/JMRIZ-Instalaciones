        ...
        <section>
        	...
        	<article Id="bienvenidos05">
				...
				<div class="box11">
				  	...
				  	<?php 
				  		...
				  		try {
							...
							$sql_1 = 'SELECT * FROM tarticulos WHERE ( Oferta = "si" AND Baja = "no" AND Existencias > 0 )';
					...
					?>
						...
						<br>
						<center><h3>Vista de los artículos disponibles en OFERTA</h3></center>
						<br>
								...
								<tbody>
								 ...
								 ?>
									...
									?>
										...
										<td style="width:60px;border: 1px solid #A4A4A4;"><?php echo"<form action='index06uno.php?usuar=$usuario' method='post'>";?>
										<input type="submit" name="agregarProd" value="añadir al carrito " >
							...
							foreach($_SESSION["carrito"] as $indice => $arreglo){
								...
								foreach ($articulos as $articulo) {
							   			...
							   			if (( $indice == $articulo['pkId_articulo'] ) && ( $arreglo["cant"] >  $articulo['Existencias'])) {
							   				...
							   				echo "<br><span style='color: white; background-color: red;'>&ensp;EXISTENCIAS&ensp;</span> ( <span style='font-size:15px; color: white; background-color: blue;'>&ensp;" . $arreglo["cant"] . "&ensp;</span> ) Articulo nº " . $indice . "<br>"; 
							   			}
								...
								echo "<a style='text-decoration: underline red;' href='index06uno.php?eliminar=true&eliminar=$indice&usuar=$usuario'><span style='font-size:15px; border-radius: 5px 5px 5px 5px; color: white; background-color: red;'>&ensp;Eliminar&ensp;</span></a></p></div>";
		  					...
		  					echo "<br><center><p>&emsp;&ensp;<a style='text-decoration: underline orange;'href='index06uno.php?usuar=$usuario&vaciar=true'><span style='font-size:20px; border-radius: 5px 5px 5px 5px; color: white; background-color: orange;'>&ensp;Vaciar carrito&ensp;</a>&emsp;&ensp;<a style='text-decoration: underline turquoise;' href='index06uno.php?usuar=$usuario&comprar=true'><span style='font-size:20px; border-radius: 5px 5px 5px 5px; color: black; background-color: turquoise;'>&ensp;Comprar&ensp;</span></a></p></center>"; 
				...
				// Acciones "VACIAR" , "COMPRAR", "ELIMINAR" 
					...
					// INICIO "VACIAR ( CARRITO COMPRAS )"	

						if(isset($_REQUEST["vaciar"])){

							unset($_SESSION["carrito"]);     
							session_destroy();               
							header("Location:index06uno.php?usuar=$usuario");
                    	}

                    // FIN "VACIAR ( CARRITO COMPRAS )"	
            		...
            		// INICIO "ELIMINAR ( PRODUCTO DEL FORMULARIO )"
						...
						if(isset($_REQUEST["eliminar"])){
								...
								echo "<script>alert('Se eliminò el producto: [ $producto ]');</script>";
